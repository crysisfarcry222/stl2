...
namespace std { namespace experimental { namespace ranges { inline namespace v1 {
  ...
  struct tagged :
    ...
    constexpr tagged(Base&&) noexcept(@\seebelow@)
      requires MoveConstructible<Base>;
    constexpr tagged(const Base&) noexcept(@\seebelow@)
...
\begin{itemdecl}
constexpr tagged(Base&& that) noexcept(@\seebelow@)
  requires MoveConstructible<Base>;
\end{itemdecl}
...
\begin{itemdecl}
constexpr tagged(const Base& that) noexcept(@\seebelow@)
  requires CopyConstructible<Base>;
\end{itemdecl}
